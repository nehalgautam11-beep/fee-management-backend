...
Pending: ₹${extraFeeStats.extraPending.toLocaleString("en-IN")}`,
    ...
    "add student": "Quick add: Students → Add Student button → Fill Name, Phone, Class, Total Fee → Confirm.",
    "edit student": "Open student details → Edit button → Modify Name, Class, or Phone (Fee locked for security).",
    ...
    "extra payment": "Extra Fees section → Select fee → Mark students as Paid → Receipt auto-generates.",
    ...
    "academic year": "Start Next Academic Year from Dashboard: Resets stats, promotes all students, and sets new fee structure.",
    "excel import": "Students page → Import button → Upload Excel/CSV with columns: Name, Phone, Class, Total Fee.",
    "excel export": "Select a class → Export button → Downloads Excel file with student data.",
